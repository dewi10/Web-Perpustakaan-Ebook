...
$sql = $koneksi->query("SELECT b.seri_buku, b.judul_buku, a.id_anggota, a.nama, s.tgl_dikembalikan
    FROM tb_sirkulasi s
...
<head>
    <meta charset="utf-8">
    <title>Laporan Perpustakaan - Log Pengembalian</title>
    ...
    <style>
        ...
        .sheet { max-width: 1200px; margin: 24px auto; background: #fff; padding: 24px; box-shadow: 0 6px 24px rgba(0,0,0,0.08); }
        .header {
            display: flex;
            align-items: center;
            gap: 18px;
...
<body>
    <div class="toolbar">
        <div><strong>Preview Cetak Log Pengembalian</strong></div>
        <div>
    ...
    <div class="sheet">
        ...
        <h4 class="report-subtitle">Riwayat Pengembalian Buku</h4>
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                while ($data = $sql->fetch_assoc()) {
                    ...
                    echo "<td>" . htmlspecialchars($data['id_anggota'] . ' - ' . $data['nama']) . "</td>";
    ...
    function closePreview() {
        ...
        window.location.href = '../../index.php?page=log_kembali';
    }
    </script>
</body>
</html>
