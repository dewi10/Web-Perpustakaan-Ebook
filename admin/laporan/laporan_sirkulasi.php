...
<section class="content">
	<div class="box box-primary">
		...
		<a href="admin/laporan/print_laporan.php" title="Print" class="btn btn-warning" target="_blank">
			...
			<div class="table-responsive">
                ...
                while ($data=mysqli_fetch_array($sql,MYSQLI_ASSOC)) {
					...
					echo '<tr>
						<td>'.$no.'</td>
						<td>'.$data['id_sk'].'</td>
						<td>'.htmlspecialchars(format_judul_buku($data['seri_buku'], $data['judul_buku'])).'</td>
