...
$query = "SELECT * FROM tb_anggota ORDER BY id_anggota";
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
    <div class="toolbar">
        <div><strong>Preview Cetak Data Anggota</strong></div>
        <div>
    ...
    <div class="sheet">
        ...
        <h4 class="report-subtitle">Data Anggota</h4>
            ...
            <tbody>
                ...
                if (mysqli_num_rows($sql) > 0) {
                    while ($data = mysqli_fetch_assoc($sql)) {
                        echo "<tr>";
                        echo "<td>" . $no++ . "</td>";
                        echo "<td>" . htmlspecialchars($data['id_anggota']) . "</td>";
                        echo "<td>" . htmlspecialchars($data['nama']) . "</td>";
                        echo "<td>" . htmlspecialchars($data['jekel']) . "</td>";
                        echo "<td>" . htmlspecialchars(format_jabatan_unit($data['kelas'] ?? '-', $data['pangkat_gol'] ?? '')) . "</td>";
                        echo "<td>" . htmlspecialchars($data['pangkat_gol'] ?? '-') . "</td>";
